                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style=""
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    style="font-family:Alice, Helvetica, Arial, sans-serif;font-size:36px;font-weight:400;line-height:40px;text-align:left;color:#1D83A8;">{{ config('app.name') }}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left"
    ...
    <tr>
        <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
            ...
            <v:rect style="width:600px;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false">
                <v:fill origin="0, -0.5" position="0, -0.5" src="http://nimus.de/share/tpl-realestate/img-1.png"
                        type="frame" size="1,1" aspect="atleast"/>
                ...
                <tr>
                    <td style="direction:ltr;font-size:0px;padding:30px;text-align:center;">
                        ...
                        <tr>
                            ...
                            <td
                                class="" style="vertical-align:middle;width:324px;"
                            >
                        <![endif]-->
                        ...
                        <td
                            class="" style="vertical-align:middle;width:216px;"
                        >
                        <![endif]-->
                                ...
                                <tr>
                                    <td style="background-color:#FFFFFF;vertical-align:middle;padding:0px;">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style=""
                                            ...
                                            <tr>
                                                <td align="center"
                                                    style="font-size:0px;padding:20px 20px 0 20px;word-break:break-word;">
                                                    <div
                                                        style="font-family:Alice, Helvetica, Arial, sans-serif;font-size:26px;font-weight:400;line-height:30px;text-align:center;color:#1D83A8;">
                                                        – Per Night –
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            {{--                                                    style="font-size:0px;padding:0 20px;word-break:break-word;">--}}
                                            {{--                                                    <div--}}
                                            {{--                                                        style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:21px;text-align:center;color:#000000;">--}}
                                            ...
                                            <tr>
                                                <td align="center" vertical-align="middle"
                                                    style="font-size:0px;padding:20px 20px 30px 20px;word-break:break-word;">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                           role="presentation"
                                                        ...
                                                        <tr>
                                                            <td align="center" bgcolor="#F44E3C" role="presentation"
                                                                ...
                                                                valign="middle">
                                                                <a href="{{ route('vacations.show', $booking->property->slug) }}"
...
{{--                                        <tr>--}}
{{--                                            <td align="center"--}}
{{--                                                style="font-size:0px;padding:0px;padding-bottom:20px;word-break:break-word;">--}}
{{--                                                <div--}}
{{--                                                    style="font-family:Alice, Helvetica, Arial, sans-serif;font-size:26px;font-weight:400;line-height:30px;text-align:center;color:#000000;">--}}
{{--                                                    Lorem Ipsum--}}
{{--                                                </div>--}}
{{--                                            </td>--}}
{{--                                        </tr>--}}
...
{{--                                        <tr>--}}
{{--                                            <td align="center"--}}
{{--                                                style="font-size:0px;padding:30px 0 10px 0;word-break:break-word;">--}}
{{--                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"--}}
{{--                                                       style="border-collapse:collapse;border-spacing:0px;">--}}
{{--                                                    <tbody>--}}
{{--                                                    <tr>--}}
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style=""
                                        ...
                                        <tr>
                                            <td style="font-size:0px;padding:20px 0;word-break:break-word;">
                                                ...
                                                <!--[if mso | IE]>
                          <table
                             align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 2px #000000;font-size:1px;margin:0px auto;width:20px;" role="presentation" width="20px"
                          >
                            <tr>
