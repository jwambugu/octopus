...
function insertPropertyToArray(property, layout) {
    ...
    if(layout == 'grid_layout'){
        element = '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><div class="property">\n' +
            ...
            '                                        </a>\n' +
            '\n' +
            '                                        <a href="https://storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-2.jpg" class="hidden"></a>\n' +
            '                                        <a href="https://storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-3.jpg" class="hidden"></a>\n' +
            '                                    </div>\n' +
            '                                </div>\n' +
            '                            </div>\n' +
            '                            <!-- Property content -->\n' +
